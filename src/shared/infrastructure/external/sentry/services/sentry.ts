...
import type { Config as SentryConfig } from "@shared/infrastructure/external/sentry/config";
  ...
  return {
    init() {
      ...
      try {
        ...
        logger.warn("Could not set up Sentry, make sure you entered a valid DSN");
      }
