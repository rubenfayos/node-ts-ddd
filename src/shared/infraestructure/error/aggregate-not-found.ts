import { ApplicationError } from "@shared/infraestructure/error/application";
...
> extends ApplicationError<TName, TMessage, TDetails> {
  constructor(message = "Requested aggregate does not exist" as TMessage, details?: TDetails) {
